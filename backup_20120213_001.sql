...
-- -----------------------------------------------------
-- Table `mydb`.`userrights`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`userrights` (
...
-- -----------------------------------------------------
-- Table `mydb`.`userroles_userrights_map`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`userroles_userrights_map` (
  `userRolesId` INT NOT NULL ,
  `userRightsId` INT NOT NULL ,
  ...
  CONSTRAINT `fk_userrights_userroles-userrights-map`
    ...
    REFERENCES `mydb`.`userrights` (`userRightsId` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '	';
...
CREATE  TABLE IF NOT EXISTS `topspejder`.`menuitems` (
  ...
  `parentItemId` INT(11) NOT NULL ,
  `menuItemWeight` INT(11) NOT NULL ,
  `fk_menuId` INT(11) NOT NULL ,
  PRIMARY KEY (`menuItemId`) ,
  UNIQUE INDEX `menuItemId` (`menuItemId` ASC) ,
  INDEX `fk_menuItems_menus` (`fk_menuId` ASC) ,
